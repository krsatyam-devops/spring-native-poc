...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.0.10/maven-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm -p 8080:8080 vanilla:0.0.1-SNAPSHOT
```
